...
class ResetPassword extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->action(Lang::getFromJson('Reset Password'), url(config('app.url').route("{$this->guard}.password.reset", ['token' => $this->token, 'email' => $notifiable->getEmailForPasswordReset()], false)))
